...
/// Handles all console-based navigation and user interaction.
/// </summary>
public class MenuController
{
    // Services used by the menu
    private readonly ApprenticeService        _apprenticeService;
    private readonly CompanyService           _companyService;
    private readonly VocationalTrainerService _trainerService;

    /// <summary>
    /// Creates the menu controller with required services.
    /// </summary>
    ...
    /// <summary>
    /// Menu for managing apprentices and their journals.
    /// </summary>
    ...
    private void ListApprentices()
    {
        ...
        if (!list.Any())
        {
            ConsoleHelper.PrintWarning("No apprentices found.");
            return;
        }
    ...
    /// <summary>
    /// Creates a new apprentice from user input.
    /// </summary>
    ...
    private void EditApprentice()
    {
        ...
        if (existing == null)
        {
            ConsoleHelper.PrintError("Apprentice not found.");
            return;
        }
    ...
    /// <summary>
    /// Deletes an apprentice after confirmation.
    /// </summary>
    private void DeleteApprentice()
    {
        ...
        if (!ConsoleHelper.Confirm($"Delete '{existing.FullName}'?"))
            return;
    ...
    /// <summary>
    /// Menu for managing work journals of a specific apprentice.
    /// </summary>
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                ...
                case "3":
                    ...
                    if (jEdit == null)
                    {
                        ConsoleHelper.PrintError("Journal not found.");
                        break;
                    }
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                case "1":
                    ...
                    if (!list.Any())
                        ConsoleHelper.PrintWarning("No companies found.");
                    else
                ...
                case "3":
                    ...
                    if (existing == null)
                    {
                        ConsoleHelper.PrintError("Company not found.");
                        break;
                    }
...
/// <summary>
/// Displays the search and filter menu.
/// Allows searching and filtering across apprentices, companies and trainers.
/// </summary>
private void SearchMenu()
{
    while (true)
    {
        ...
        {
            case "1":
                // Search apprentices by full name
            ...
            case "2":
                // Filter apprentices by company ID
            ...
            case "5":
                // Search vocational trainers by name
...
/// <summary>
/// Prints a list of search results or a warning if no results were found.
/// </summary>
